...
const AppLauncherModal: React.FC<AppLauncherModalProps> = ({ isOpen, onClose, menuStyle = 'classic', currentAppName }) => {
  ...
  const loadApps = async () => {
    try {
      ...
      setApps([
        { id: 1, app_name: 'ERROR: ' + error.message, desc_en: 'TMS', desc_th: 'TMS', icon_path: '/apps/nexspeed.png', theme_color: '#3B82F6', status: 'active', app_group: 'System', seq_no: 1 },
        { id: 2, app_name: 'NexSite', desc_en: 'Site', desc_th: 'Site', icon_path: '/apps/nexsite.png', theme_color: '#10B981', status: 'active', app_group: 'Portal & Workspace', seq_no: 2 },
        { id: 3, app_name: 'NexForce', desc_en: 'Force', desc_th: 'Force', icon_path: '/apps/nexforce.png', theme_color: '#F59E0B', status: 'active', app_group: 'Workforce & HR', seq_no: 3 },
        { id: 4, app_name: 'NexCost', desc_en: 'Cost', desc_th: 'Cost', icon_path: '/apps/nexcost.png', theme_color: '#EF4444', status: 'active', app_group: 'Finance & Accounting', seq_no: 4 },
        { id: 5, app_name: 'NexStock', desc_en: 'Stock', desc_th: 'Stock', icon_path: '/apps/nexstock.png', theme_color: '#8B5CF6', status: 'active', app_group: 'Operations & Logistics', seq_no: 5 }
      ]);
    } finally {
      setLoading(false);
    }
