...
{
    public class AdditionEmployeeAssignmentConfiguration : IEntityTypeConfiguration<AdditionEmployeeAssignment>
    {
        public void Configure(EntityTypeBuilder<AdditionEmployeeAssignment> builder)
        {
            ...
            builder.Property(e => e.AdditionsId)
