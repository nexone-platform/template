...
export default function StatusDropdown({ value, onChange, options = defaultOptions, hideIcon = false, disabled = false }: StatusDropdownProps) {
    ...
    return (
        <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
            ...
            >
                ...
                {!disabled && <ChevronDown size={14} style={{ opacity: 0.5, marginLeft: '2px' }} />}
            </div>
